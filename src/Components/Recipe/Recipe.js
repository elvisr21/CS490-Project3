        ...
        <>
            { (recipe!=undefined) && 
                <div className="recipe"> 
                    ...
                    <div className="Instructions">Instructions:  <br/>
                        {
                            recipe['instructions'].map((instruction,index)=>{
                                return <div className='instruction'>{index+1}. {instruction} </div>
                            })
                        }
                    </div>
                    <br/>
                            ...
                            return(
                                <div className="Comment">
                                        <div className="Comment_Creator">
                                            creator={comment[1]['name']} 
                                        </div>
                                        <div className="creator_id">
                                            creator_id={comment[1]['id']} 
                                        </div>
                                        <div className="Comment">
